                ...
                DB::transaction(function () use ($pc, &$published) {
                    ...
                    SaccoRoutes::updateOrCreate(
                        ...
                        [
                            ...
                            'peak_fare' => $pc->peak_fare !== null && (float) $pc->peak_fare > 0 ? (float) $pc->peak_fare : null,
                            'off_peak_fare' => $pc->off_peak_fare !== null && (float) $pc->off_peak_fare > 0 ? (float) $pc->off_peak_fare : null,
